...
Instruction ParseInstructionIdaPpc(const insn_t& instruction,
  ...
  if (instruction.auxpref & PPC_aux_oe) mnemonic += "o";
  if (instruction.auxpref & PPC_aux_ctr) mnemonic += "ctr";
  if (instruction.auxpref & PPC_aux_rc) mnemonic += ".";
  if (instruction.auxpref & PPC_aux_lr) mnemonic += "lr";
  if (instruction.auxpref & PPC_aux_lk) mnemonic += "l";
  if (instruction.auxpref & PPC_aux_aa) mnemonic += "a";
  if (instruction.auxpref & PPC_aux_plus) mnemonic += "+";
  if (instruction.auxpref & PPC_aux_minus) mnemonic += "-";
